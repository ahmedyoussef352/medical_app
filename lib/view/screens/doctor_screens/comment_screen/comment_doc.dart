...
class CommentScreenDoc extends StatefulWidget {
  dynamic posts;
   CommentScreenDoc({super.key,required this.posts});

  @override
  State<CommentScreenDoc> createState() => _CommentScreenDocState();
}

class _CommentScreenDocState extends State<CommentScreenDoc> with Crud {
                    ...
                    return AlertDialog(
                      ...
                      actions: <Widget>[
                        ...
                        TextButton(
                          ...
                          onPressed: () async {
                            await cubit.addCommentDoc(context,
                                time: formattedTime,
